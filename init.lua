...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>oj', group = '[J]ump' },
        { '<leader>oj_', hidden = true },
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sF', function()
        require('telescope.builtin').find_files {
          ...
          -- hidden = false,
          find_command = { 'fd', '--type', 'f', '--max-depth', '1', '--hidden', '--no-ignore' },
        }
      end, { desc = '[S]earch [F]iles in this files dir' })
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      vim.cmd.colorscheme 'tokyonight-zenburn'
  ...
  {
    'tanj/zenburn.nvim',
    -- semantic token highlights look like ass in here. Maybe fork and improve
